...
class VitalSign(models.Model):
    ...
    def high_risk_reasons(self):
        """List reasons this vital is considered high-risk"""
        reasons = []
...
class MedicalRecord(models.Model):
    ...
    def __str__(self):
        return f"Record for {self.patient} on {self.created_at.strftime('%Y-%m-%d')}"
...
class LabResult(models.Model):
    ...
    def __str__(self):
        return f"{self.test_name} ({self.status}) for {self.patient}"